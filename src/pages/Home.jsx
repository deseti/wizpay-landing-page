      ...
      <header className="sticky top-0 z-40 border-b border-white/8 bg-[#050816]/75 backdrop-blur-xl">
        <div className="section-shell flex items-center justify-between py-4">
          ...
          <nav className="hidden items-center gap-6 text-sm text-slate-300 md:flex">
            ...
            <a href={GITHUB_URL} target="_blank" rel="noopener noreferrer" className="transition hover:text-white flex items-center gap-1.5" title="View source on GitHub"><GitHubIcon size={16} /> GitHub <span className="text-[10px] opacity-70">↗</span></a>
          </nav>
